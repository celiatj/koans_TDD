...
describe("20-Clases101.js", () => {
  ...
  it("se pueden crear nuevas instancias", () => {
    ...
    expect(unNumeroMasDiez).toBe(unNumero + 10); //otras opciones: "function Number() { [native code] }10" y Numero+10
    // Añade algo de contenido dentro de las comillas.
  ...
  it("DIY", () => {
    ...
    expect(BiciElectrica).not.toBeUndefined(undefined);
  ...
  it("los nombres de las clases se definen con cada primera letra de cada palabra en mayúsculas", () => {
    ...
    const soyUnaVariableEnCamelCase =
      "solo la primera letra de la primera palabla en minúsculas";
