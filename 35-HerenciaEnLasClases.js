describe("35-HerenciaEnLasClases.js", () => {
  ...
  it("hace que hereden comportamiento y atributos", () => {
    ...
    expect(nuevaTele.estaEncendida).toBe(true);
  ...
  it("la clase que hereda, puede ser heredada por una tercera", () => {
    ...
    expect(nuevaTeleModerna.canalActual).toBe(22);
    ...
    // a dormir.
    // Escribe aquí tu código:
    while (nuevaTeleModerna.canalActual < 33) {
      nuevaTeleModerna.cambiarAlSiguienteCanal();
    }
    nuevaTeleModerna.apagar();
  ...
  it("la clase que hereda, puede modificar los atributos de la clase heredada", () => {
    ...
    expect(puntosDeSanacion).toBe(10);
    expect(nuevoSanador.puntosDeMana).toBe(80);
    // ¿Puedes ponerlo a sanar hasta que se quede sin mana?
    // Escribe aquí tu código:

    while (nuevoSanador.puntosDeMana > 0) {
      nuevoSanador.sanar();
    }
    ...
    while (nuevoSanadorNovato.puntosDeMana > 26) {
      nuevoSanadorNovato.sanar();
    }
    ...
    // Escribe aquí tu código:
    while (nuevoSanadorAventurero.puntosDeMana > 16) {
      nuevoSanadorAventurero.sanar();
    }
    ...
    // Escribe aquí tu código:
    const SanadorExperto = class extends Sanador {
      constructor() {
        super();

        this.puntosDeMana = 150;
        this.cantidadSanada = 30;
        this.manaConsumidoPorSanacion = 10;
      }
      descansar() {
        this.puntosDeMana += 10;
      }
    };
