...
describe("44-Scope.js", () => {
  ...
  it("un bloque dentro de un bloque", () => {
    ...
    expect(variableEnElScopeDelPrimerTest).toBe("valorEnElScopePrimerTest");
  ...
  it("un coche dentro de otro, ambos con las ventanas tintadas", () => {
    ...
    expect(variableEnElScopeGlobal).toBe("valorEnElScopeGlobal");
    expect(variableEnElScopeDelDescribe).toBe("valorEnElScopeDelDescribe");
    expect(variableEnElScopeDelSegundoTest).toBe("valorEnElScopeSegundoTest");
  ...
  it("el scope de las funciones", () => {
    ...
    expect(funcionConSuScope()).toBe("unValorEnUnaFuncion");
    expect(() => {
  ...
  it("scopes de la parte estática de la clase", () => {
    ...
    expect(Clase.atributoEnELScopeDeLaClase).toBe("atributoEnELScopeDeLaClase");
    expect(Clase.unMetodoEnElScopeDeLaClase()).toBe(
      "atributoEnELScopeDeLaClase"
    );
    expect(Clase.otroMetodoEnElScopeDeLaClse()).toBe(
      "otroMetodoEnElScopeDeLaClse"
    );
    expect(Clase.intentandoAccederAlScopeDeLaInstancia()).toBe(undefined);
    const clase = new Clase();
    expect(clase.atributoEnELScopeDeLaInstancia).toBe(
      "atributoEnELScopeDeLaInstancia"
    );
  ...
  it("scopes dentro de la instance de clase", () => {
    ...
    expect(clase.unMetodoEnElScopeDeLaInstancia()).toBe(
      "atributoEnELScopeDeLaInstancia"
    );
    expect(clase.otroMetodoEnElScopeDeLaInstancia()).toBe(
      "otroMetodoEnElScopeDeLaInstancia"
    );
    expect(clase.intentandoAccederAlScopeDeLaClase()).toBe(undefined);
  });
  ...
  it("los métodos de las clases son un bloque de código más", () => {
    ...
    const clase = new Clase();
    expect(clase.intentandoAccederAlScopeGlobal()).toBe("valorEnElScopeGlobal");
    expect(clase.intentandoAccederAlScopeDelDescribe()).toBe(
      "valorEnElScopeDelDescribe"
    );
    expect(clase.intentandoAccederAlScopeDelTest()).toBe(
      "valorEnElScopeDelTest"
    );
  });
});
