describe("36-Ordenadores.js", () => {
  ...
  class PortatilParaProgramar extends Portatil {
    constructor() {
      super();
      this.estaProgramando = false;
    }
    programar() {
      if (this.cargaBateria != 0 && this.estaEncendido === true) {
        this.estaProgramando = true;
      } else {
        this.estaProgramando = false;
      }
    }
  ...
  class PortatilParaJugar extends Portatil {
    constructor() {
      super();
